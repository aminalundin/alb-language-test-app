...
checkButton.addEventListener('click', function (event) {
    ...
    const correctValues = {
        "sis": "Motër e madhe",
        "his-sis": "Ajo është motra e tij e madhe",
        "bro": "Vëlla i madh",
        "her-bro": "Ai është vëllai i saj i madh",
        "y-sis": "Motër e vogël",
        "my-sis": "Unë kam tre motra më të vogla",
        "y-bro": "Vëlla i vogël",
        "one-bro": "Ti ke një vëlla më të vogël",
        "sib": "Vëlla ose motër",
        "t-sib": "Ata janë vëllezërit dhe motrat e mia"
    };
