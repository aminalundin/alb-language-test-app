...
checkButton.addEventListener('click', function (event) {
    ...
    const correctValues = {
        "learn": "Të mësosh",
        "i-learn": "Unë mësoj gjermanisht",
        "eat": "Të hash",
        "jp-eat": "Unë ha ushqim japonez",
        "read": "Të lexosh",
        "ch-read": "Ai lexon një liber kinez",
        "drink": "Të pish",
        "drink-coffee": "Ajo pi kafe të nxehtë",
        "buy": "Të blesh",
        "you-buy": "Ti blen një gazetë anglisht"
    };
